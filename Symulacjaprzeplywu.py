...
class SymulacjaKaskady(QWidget):
    def __init__(self):
        ...
        #Przycisk napelniajacy zbiornik 1
        ...
        self.btn2.clicked.connect(lambda : (self.z1.set_full(), self.update()))

        #Przycisk oprozniajacy zbiornik 1
        ...
        self.btn3.clicked.connect(lambda : (self.z1.set_empty(), self.update()))

        #Przycisk napelniajacy zbiornik 2
        ...
        self.btn4.clicked.connect(lambda : (self.z2.set_full(), self.update()))

        #Przycisk oprozniajacy zbiornik 2
        ...
        self.btn5.clicked.connect(lambda : (self.z2.set_empty(), self.update()))

        #Przycisk napelniajacy zbiornik 3
        ...
        self.btn6.clicked.connect(lambda : (self.z3.set_full(), self.update()))

        #Przycisk oprozniajacy zbiornik 3
        ...
        self.btn7.clicked.connect(lambda : (self.z3.set_empty(), self.update()))
